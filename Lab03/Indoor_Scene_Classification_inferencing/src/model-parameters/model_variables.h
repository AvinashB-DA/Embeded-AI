...
const char* ei_classifier_inferencing_categories[] = { "android", "box", "mouse" };

ei_dsp_named_axis_t ei_dsp_config_3_named_axes[] = {
    { .name = "Image", .axis = 0 }
};
size_t ei_dsp_config_3_named_axes_size = 1;
...
ei_dsp_config_image_t ei_dsp_config_3 = {
    ...
    ei_dsp_config_3_named_axes, // named axes
    ei_dsp_config_3_named_axes_size, // size of the named axes array
    "RGB" // select channels
};
...
const uint32_t ei_learning_block_4_inputs[1] = { 3 };
...
const ei_impulse_t impulse_541977_0 = {
    .project_id = 541977,
    .project_owner = "Avinash Baraiya",
    .project_name = "Indoor Scene Classification",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_541977_0 = ei_impulse_handle_t( &impulse_541977_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_541977_0;
